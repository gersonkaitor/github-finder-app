      ...
      <div className="w-full mx-auto lg:w-10/12 text-primary-content">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
          <div className="custom-card-image mb-6 md:mb-0 ">
            <div className="rounded-lg shadow-xl card image-full">
              ...
              <div className="card-body justify-end">
                <h2 className="card-title mb-0 text-primary-content">{name}</h2>
          ...
          <div className="col-span-2">
            ...
            <div className="w-full rounded-lg shadow-md bg-base-100 text-primary-content stats stats-vertical lg:stats-horizontal">
            {location && (
                <div className='stat'>
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 text-primary-content stats stats-vertical lg:stats-horizontal">
